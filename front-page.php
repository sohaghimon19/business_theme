<?php get_header(); ?>
  ...
  <div class="jumbotron">
    ...
    <p class="lead"><?php echo get_theme_mod('banner_text', 'Welcome to the Wordpress Business Theme. This theme uses the Twitter Bootstrap 4 framework and can be customized to your liking');?></p>
    <p><a class="btn btn-lg btn-primary" href="<?php echo get_theme_mod('banner_btn_url', 'http://test.com');?>" role="button"><?php echo get_theme_mod('button_text', 'Read more');?></a></p>
  </div>
  <!-- .container -->
  </div>
  <!-- .jumbotron -->
  ...
  <section class="row marketing">
    ...
    <div class="col-md-4">
      <div class="block">
        <i class="fa fa-<?php echo get_theme_mod('box1_icon', 'bar-char');?> fa-3"></i>
