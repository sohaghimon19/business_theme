...
<body>
        ...
        <div class="container">
          ...
          <div class="col-md-4">
            <div class="side-widget">
              <h3>Text Widget</h3>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam lorem arcu, vestibulum egestas posuere eu, aliquet eu felis.</p>
            </div>
      ...
      <div class="container">
        ...
        <div class="col-md-7">
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item"><i class="fa fa-check" aria-hidden="true"></i> Bootstrap 4 Framework</li>
    ...
    <footer class="footer content-region-3 pt30 pb40">
      ...
      <div class="copyright-section text-center">
        <span>Copyright © 2019 Sohag Himon. All Rights Reserved</span>
      </div>
