...
function business_customize_register($wp_customize)
{
  ...
  $wp_customize->add_setting('banner_text', array(
    'default'   => _x('Welcome to the Wordpress Business Theme. This theme uses the Twitter Bootstrap 4 framework and can be customized to your liking', 'business'),
    'type'      => 'theme_mod'
  ));
  ...
  $wp_customize->add_setting('banner_image', array(
    'default'    => get_bloginfo('template_directory') . '/img/search-background.jpg',
    'type'      => 'theme_mod'
  ));
...
// Boxes Section
  $wp_customize->add_section('boxes', array(
    ...
    'description'    => sprintf(
      __('Options for homepage boxes', 'business')
    ),
    'priority'       => 130,
  ));
  ...
  $wp_customize->add_section('footer', array(
    'title'       => __('Footer Image', 'business'),
    'description' => sprintf(__('Options for footer footer', 'business')),
    'priority'    => 160
  ));
